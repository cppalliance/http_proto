...
#ifndef BOOST_HTTP_PROTO_IMPL_FILE_POSIX_IPP
#define BOOST_HTTP_PROTO_IMPL_FILE_POSIX_IPP
...
#if ! defined(BOOST_HTTP_PROTO_NO_POSIX_FADVISE)
# if defined(__APPLE__) || (defined(__ANDROID__) && (__ANDROID_API__ < 21))
#  define BOOST_HTTP_PROTO_NO_POSIX_FADVISE
# endif
#endif

#if ! defined(BOOST_HTTP_PROTO_USE_POSIX_FADVISE)
# if ! defined(BOOST_HTTP_PROTO_NO_POSIX_FADVISE)
#  define BOOST_HTTP_PROTO_USE_POSIX_FADVISE 1
# else
#  define BOOST_HTTP_PROTO_USE_POSIX_FADVISE 0
# endif
#endif
